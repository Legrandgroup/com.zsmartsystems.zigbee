...
public enum EmberApsOption {
	...
	/**
	 * Causes a route discovery to be initiated if no route to the destination is
	 * known.
	 */
	...
	/**
	 * Send a ZDO request to discover the node ID of the destination, if it is not
	 * already know.
	 */
	 ...
	 * and the application is responsible for sending a ZDO response. This flag is
	 * used only when the ZDO is configured to have requests handled by the
	 * application. See the EZSP_CONFIG_APPLICATION_ZDO_FLAGS configuration
	 * parameter for more information.
	 */
	EMBER_APS_OPTION_ZDO_RESPONSE_REQUIRED(0x4000),

	/**
	 * This message is part of a fragmented message. This option may only be set for
	 * unicasts. The groupId field gives the index of this fragment in the low-order
	 * byte. If the low-order byte is zero this is the first fragment and the
	 * high-order byte contains the number of fragments in the message.
	 */
