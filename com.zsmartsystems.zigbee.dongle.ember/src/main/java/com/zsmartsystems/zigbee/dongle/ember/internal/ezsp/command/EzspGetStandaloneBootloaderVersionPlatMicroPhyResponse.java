...
public class EzspGetStandaloneBootloaderVersionPlatMicroPhyResponse extends EzspFrameResponse {
	...
	/**
	 * BOOTLOADER_INVALID_VERSION if the standalone bootloader is not present, or
	 * the version of the installed standalone bootloader.
	 * <p>
	 ...
	 *            the bootloaderVersion to set as {@link int}
	 */
	 ...
	 *
	 * @param nodePlat
	 *            the nodePlat to set as {@link int}
	 */
	 ...
	 *
	 * @param nodeMicro
	 *            the nodeMicro to set as {@link int}
	 */
	 ...
	 *
	 * @param nodePhy
	 *            the nodePhy to set as {@link int}
	 */
