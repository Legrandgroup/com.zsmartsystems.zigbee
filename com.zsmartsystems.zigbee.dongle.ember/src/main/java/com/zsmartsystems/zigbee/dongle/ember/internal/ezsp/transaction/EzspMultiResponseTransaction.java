...
/**
 * Multiple EZSP transaction response handling. This matches a
 * {@link EzspFrameRequest} which returns with multiple
 * {@link EzspFrameResponse}. {@link EzspFrame#frameId} must also match on the
 * first response.
 * <p>
 * As example of this transaction is the SCAN requests. Such requests to the
 * EZSP NCP result in multiple responses -:
 * <ul>
 ...
 * </ul>
 * <p>
 * This transaction handler will record all responses related to the request,
 * but only complete on the final response.
 *
