...
public enum EzspPolicyId {
	...
	/**
	 * Controls whether the message contents are included in the messageSentHandler
	 * callback.
	 */
	...
	/**
	 * Controls whether ZigBee packets that appear invalid are automatically dropped
	 * by the stack. A counter will be incremented when this occurs.
	 */
