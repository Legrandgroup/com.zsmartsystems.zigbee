 ...
 * transmission to be consumed by a route request as part of discovery, so the
 * application payload of this packet will not reach its destination on the
 * first attempt. If you want the packet to reach its destination, the APS_RETRY
 * option must be set so that another attempt is made to transmit the message
 * with its application payload after the route has been constructed.
 * <p>
 * <b>Note:</b> When sending fragmented messages, the stack will only assign a
 * new APS sequence number for the first fragment of the message (i.e.,
...
public class EzspSendUnicastRequest extends EzspFrameRequest {
	 ...
	 * <p>
	 * EZSP type is <i>EmberOutgoingMessageType</i> - Java type is
	 * {@link EmberOutgoingMessageType}
	 */
	 ...
	 *
	 * @param type
	 *            the type to set as {@link EmberOutgoingMessageType}
	 */
	 ...
	 *            the indexOrDestination to set as {@link int}
	 */
