...
public enum EmberZdoConfigurationFlags {
	 ...
	 * handled by the EmberZNet stack. The stack will continue to handle the request
	 * and send the appropriate ZDO response even if this configuration option is
	 * enabled.
	 */
	 ...
	 * incomingMessageHandler callback. An unsupported ZDO request is one that is
	 * not handled by the EmberZNet stack, other than to send a 'not supported' ZDO
	 * response. If this configuration option is enabled, the stack will no longer
	 * send any ZDO response, and it is the application's responsibility to do so.
	 */
	 ...
	 * response for these requests, and it is the application's responsibility to do
	 * so.
	 */
	 ...
	 * UNBIND_REQUEST. If this configuration option is enabled, the stack will no
	 * longer send any ZDO response for these requests, and it is the application's
