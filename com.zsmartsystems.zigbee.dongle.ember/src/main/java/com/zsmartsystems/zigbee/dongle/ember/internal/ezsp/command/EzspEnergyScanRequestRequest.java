...
public class EzspEnergyScanRequestRequest extends EzspFrameRequest {
	...
	/**
	 * How long to scan on each channel. Allowed values are 0..5, with the scan
	 * times as specified by 802.15.4 (0 = 31ms, 1 = 46ms, 2 = 77ms, 3 = 138ms, 4 =
	 * 261ms, 5 = 507ms).
	 * <p>
	 ...
	 *
	 * @param scanChannels
	 *            the scanChannels to set as {@link int}
	 */
	 ...
	 *
	 * @param scanDuration
	 *            the scanDuration to set as {@link int}
	 */
	 ...
	 *
	 * @param scanCount
	 *            the scanCount to set as {@link int}
	 */
