...
public enum EzspDecisionId {
	 ...
	 * trust center and any rejoining device are assumed to share a link key, either
	 ...
	 * previous policy. This is the default value for the EZSP_TRUST_CENTER_POLICY.
	 */
	EZSP_ALLOW_PRECONFIGURED_KEY_JOINS(0x0001),

	/**
	 * Send the network key encrypted with the rejoining device's trust center link
	 * key. The trust center and any rejoining device are assumed to share a link
	 * key, either preconfigured or obtained under a previous policy. No new devices
	 * are allowed to join.
	 */
	...
	/**
	 * EZSP_UNICAST_REPLIES_POLICY default decision. The NCP will automatically send
	...
	/**
	 * EZSP_TC_KEY_REQUEST_POLICY decision. When the Trust Center receives a request
	...
	/**
	 * EZSP_TC_KEY_REQUEST_POLICY decision. When the Trust Center receives a request
	 * for a Trust Center link key, it will reply to it with the corresponding key.
	 */
	...
	/**
	 * EZSP_APP_KEY_REQUEST_POLICY decision. When the Trust Center receives a
	 * request for an application link key, it will randomly generate a key and send
	 * it to both partners.
	 */
