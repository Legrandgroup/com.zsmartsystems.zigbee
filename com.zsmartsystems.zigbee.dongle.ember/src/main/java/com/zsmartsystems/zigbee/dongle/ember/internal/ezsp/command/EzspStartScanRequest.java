...
public class EzspStartScanRequest extends EzspFrameRequest {
	 ...
	 * EZSP_ENERGY_SCAN and EZSP_ACTIVE_SCAN. For each type, the respective callback
	 * for reporting results is: energyScanResultHandler and networkFoundHandler.
	 * The energy scan and active scan report errors and completion via the
	 * scanCompleteHandler
	 * <p>
	 * EZSP type is <i>EzspNetworkScanType</i> - Java type is
	 * {@link EzspNetworkScanType}
	 */
	 ...
	 * example, a channelMask value of 0x00000001 would indicate that only channel 0
	 * should be scanned. Valid channels range from 11 to 26 inclusive. This
	 * translates to a channel mask value of 0x07FFF800. As a convenience, a value
	...
	/**
	 * Sets the exponent of the number of scan periods, where a scan period is 960
	 * symbols. The scan will occur for ((2^duration) + 1) scan periods.
	 * <p>
	 ...
	 *
	 * @param scanType
	 *            the scanType to set as {@link EzspNetworkScanType}
	 */
	 ...
	 *
	 * @param channelMask
	 *            the channelMask to set as {@link int}
	 */
	 ...
	 *
	 * @param duration
	 *            the duration to set as {@link int}
	 */
