...
/**
 * This class provides utility functions to configure, and read the
 * configuration from the Ember stack.
 *
...
public class EmberStackConfiguration {
	...
	/**
	 * Configuration utility. Takes a {@link Map} of {@link EzspConfigId} to
	 * {@link Integer} and will work through setting them before returning.
	 *
	 * @param configuration
	 *            {@link Map} of {@link EzspConfigId} to {@link Integer} with
	...
	/**
	 * Configuration utility. Takes a {@link Set} of {@link EzspConfigId} and will
	 * work through requesting them before returning.
	 *
	 * @param configuration
	 *            {@link Set} of {@link EzspConfigId} to request
	 * @return map of configuration data mapping {@link EzspConfigId} to
	 *         {@link Integer}. Value will be null if error occurred.
	 */
	 ...
	 *
	 * @param policyId
	 *            the {@link EzspPolicyId} to set
	 * @param decisionId
	 *            the {@link EzspDecisionId} to set to
	 ...
	 * @param policyId
	 *            the {@link EzspPolicyId} to set
	 * @return the returned {@link EzspDecisionId} if the policy was retrieved
	...
	/**
	 * Configuration utility. Takes a {@link Map} of {@link EzspConfigId} to
	 * {@link EzspDecisionId} and will work through setting them before returning.
	 *
	 * @param policies
	 *            {@link Map} of {@link EzspPolicyId} to {@link EzspDecisionId} with
	 *            configuration to set
	...
	/**
	 * Configuration utility. Takes a {@link Set} of {@link EzspPolicyId} and will
	 * work through requesting them before returning.
	 *
	 * @param policies
	 *            {@link Set} of {@link EzspPolicyId} to request
	 * @return map of configuration data mapping {@link EzspPolicyId} to
	 *         {@link EzspDecisionId}. Value will be null if error occurred.
	 */
