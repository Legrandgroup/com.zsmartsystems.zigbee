...
public class EmberNetworkParameters {
	...
	/**
	 * NWK Manager ID. The ID of the network manager in the current network. This
	 * may only be set at joining when using EMBER_USE_NWK_COMMISSIONING as the join
	 * method.
	 * <p>
	...
	/**
	 * NWK Update ID. The value of the ZigBee nwkUpdateId known by the stack. This
	 * is used to determine the newest instance of the network after a PAN ID or
	 * channel change. This may only be set at joining when using
	 ...
	 * told this device to use when searching for the network. This may only be set
	 ...
	 *
	 * @param extendedPanId
	 *            the extendedPanId to set as {@link ExtendedPanId}
	 */
	 ...
	 *
	 * @param radioTxPower
	 *            the radioTxPower to set as {@link int}
	 */
	 ...
	 *
	 * @param radioChannel
	 *            the radioChannel to set as {@link int}
	 */
	 ...
	 *
	 * @param joinMethod
	 *            the joinMethod to set as {@link EmberJoinMethod}
	 */
	 ...
	 *
	 * @param nwkManagerId
	 *            the nwkManagerId to set as {@link int}
	 */
	 ...
	 *
	 * @param nwkUpdateId
	 *            the nwkUpdateId to set as {@link int}
	 */
	 ...
	 *
	 * @param channels
	 *            the channels to set as {@link int}
	 */
