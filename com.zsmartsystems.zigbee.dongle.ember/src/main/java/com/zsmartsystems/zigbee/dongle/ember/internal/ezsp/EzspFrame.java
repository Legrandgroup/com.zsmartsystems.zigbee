...
public abstract class EzspFrame {
	 ...
	 *
	 * @return the {@link EzspFrameResponse} or null if the response can't be
	 *         created.
	 */
	...
	/**
	 * Gets the current version of EZSP that is in use. This will default to the
	 * minimum supported version on startup
	 *
