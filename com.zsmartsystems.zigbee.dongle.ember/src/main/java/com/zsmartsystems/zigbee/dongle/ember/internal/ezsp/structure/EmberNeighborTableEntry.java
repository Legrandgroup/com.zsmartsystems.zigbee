 ...
 * <p>
 * A neighbor table entry stores information about the reliability of RF links
 * to and from neighboring nodes.
 * <p>
...
public class EmberNeighborTableEntry {
	...
	/**
	 * The incoming cost for this neighbor, computed from the average LQI. Values
	 * range from 1 for a good link to 7 for a bad link.
	 * <p>
	 * EZSP type is <i>uint8_t</i> - Java type is {@link int}
	 */
	private int inCost;
	...
	/**
	 * The outgoing cost for this neighbor, obtained from the most recently received
	 * neighbor exchange message from the neighbor. A value of zero means that a
	 * neighbor exchange message from the neighbor has not been received recently
	 * enough, or that our id was not present in the most recently received one.
	 * <p>
	 * EZSP type is <i>uint8_t</i> - Java type is {@link int}
	 */
	private int outCost;
	...
	/**
	 * The number of aging periods elapsed since a link status message was last
	 * received from this neighbor. The aging period is 16 seconds.
	 * <p>
	 * EZSP type is <i>uint8_t</i> - Java type is {@link int}
	 */
	private int age;
	 ...
	 *
	 * @param shortId
	 *            the shortId to set as {@link int}
	 */
	 ...
	 *
	 * @param averageLqi
	 *            the averageLqi to set as {@link int}
	 */
	 ...
	 *
	 * @param outCost
	 *            the outCost to set as {@link int}
	 */
	 ...
	 *
	 * @param longId
	 *            the longId to set as {@link IeeeAddress}
	 */
