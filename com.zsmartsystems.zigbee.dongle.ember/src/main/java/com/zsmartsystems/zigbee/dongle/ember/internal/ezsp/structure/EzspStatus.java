...
public enum EzspStatus {
	...
	/**
	 * The Response frame of the current transaction indicates the frame terminator
	 * is missing from the Command frame.
	 */
	...
	/**
	 * The overflow flag in the frame control field was set, indicating one or more
	 * callbacks occurred since the previous response and there was not enough
	 * memory available to report them to the Host.
	 */
