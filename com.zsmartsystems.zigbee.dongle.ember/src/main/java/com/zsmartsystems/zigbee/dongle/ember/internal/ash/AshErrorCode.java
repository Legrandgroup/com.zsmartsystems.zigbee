...
/**
 * Lists the codes returned by the NCP in the Reset Code byte of a RSTACK frame
 * or in the Error Code byte of an ERROR frame.
 *
 * @author Chris Jackson
 *
 */
public enum AshErrorCode {
	UNKNOWN(-1, "Unknown"), RESET_UNKNOWN(0x00, "Reset: Unknown reason"), RESET_EXTERNAL(0x01,
			"Reset: External"), RESET_POWER_ON(0x02, "Reset: Power-on"), RESET_WATCHDOG(0x03,
					"Reset: Watchdog"), RESET_ASSERT(0x06, "Reset: Assert"), RESET_BOOTLOADER(0x09,
							"Reset: Boot loader"), RESET_SOFTWARE(0x0B, "Reset: Software"), RESET_TIMEOUT(0x51,
