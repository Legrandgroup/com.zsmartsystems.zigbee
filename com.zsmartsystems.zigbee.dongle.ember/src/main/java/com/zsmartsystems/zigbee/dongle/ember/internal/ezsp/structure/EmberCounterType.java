...
public enum EmberCounterType {
	...
	/**
	 * A message was dropped at the network layer because the NWK frame counter was
	 * not higher than the last message seen from that source.
	 */
	EMBER_COUNTER_NWK_FRAME_COUNTER_FAILURE(0x0015),

	/**
	 * A message was dropped at the APS layer because the APS frame counter was not
	...
	/**
	 * A message was dropped at the APS layer because it had APS encryption but the
	 * key associated with the sender has not been authenticated, and thus the key
