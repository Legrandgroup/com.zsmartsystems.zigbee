...
public class EmberBindingTableEntry {
	 ...
	 * This cluster ID is set by the provisioning application to indicate which part
	 * an endpoint's functionality is bound to this particular remote node and is
	 * used to distinguish between unicast and multicast bindings. Note that a
	 * binding can be used to send messages with any cluster ID, not just that
	...
	/**
	 * A 64-bit identifier. This is either the destination EUI64 (for unicasts) or
	 * the 64-bit group address (for multicasts).
	 * <p>
	 ...
	 *
	 * @param type
	 *            the type to set as {@link EmberBindingType}
	 */
	 ...
	 *
	 * @param clusterId
	 *            the clusterId to set as {@link int}
	 */
	 ...
	 *
	 * @param identifier
	 *            the identifier to set as {@link IeeeAddress}
	 */
	 ...
	 *
	 * @param uint8_t
	 *            the uint8_t to set as {@link int}
	 */
