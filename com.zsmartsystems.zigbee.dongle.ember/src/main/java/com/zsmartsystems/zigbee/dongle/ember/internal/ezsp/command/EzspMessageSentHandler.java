...
public class EzspMessageSentHandler extends EzspFrameResponse {
	...
	/**
	 * The destination to which the message was sent, for direct unicasts, or the
	 * address table or binding index for other unicasts. The value is unspecified
	 * for multicasts and broadcasts.
	 * <p>
	 ...
	 * included here if the decision for the messageContentsInCallback policy is
