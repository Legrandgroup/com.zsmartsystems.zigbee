...
public class EzspSetConcentratorRequest extends EzspFrameRequest {
	...
	/**
	 * Must be either EMBER_HIGH_RAM_CONCENTRATOR or EMBER_LOW_RAM_CONCENTRATOR. The
	 * former is used when the caller has enough memory to store source routes for
	 * the whole network. In that case, remote nodes stop sending route records once
	 * the concentrator has successfully received one. The latter is used when the
	 * concentrator has insufficient RAM to store all outbound source routes. In
	 * that case, route records are sent to the concentrator prior to every inbound
	 * APS unicast.
	 * <p>
	 * EZSP type is <i>EmberConcentratorType</i> - Java type is
	 * {@link EmberConcentratorType}
	 */
	 ...
	 *
	 * @param enable
	 *            the enable to set as {@link boolean}
	 */
	 ...
	 *            the concentratorType to set as {@link EmberConcentratorType}
	 */
	 ...
	 *
	 * @param minTime
	 *            the minTime to set as {@link int}
	 */
	 ...
	 *
	 * @param maxTime
	 *            the maxTime to set as {@link int}
	 */
	 ...
	 *            the routeErrorThreshold to set as {@link int}
	 */
	 ...
	 *            the deliveryFailureThreshold to set as {@link int}
	 */
	 ...
	 *
	 * @param maxHops
	 *            the maxHops to set as {@link int}
	 */
