 ...
 * <p>
 * The transaction looks for a {@link EzspFrameResponse} that matches the
 * {@link EzspFrameRequest}. The {@link EzspFrameResponse} and
 * {@link EzspFrameRequest} classes are provided when the transaction is
 * created.
 *
...
public interface EzspTransaction {
	 ...
	 *
	 * @param response
	 *            the response {@link EzspFrameResponse}
	...
	/**
	 * Gets the {@link EzspFrameResponse} for the transaction. If multiple responses
	 * are returned, this will return the last response, indicating the final
	 * response used to complete the transaction.
	 *
	 * @return {@link EzspFrameResponse} to complete the transaction or null if no
	 *         response received
	 */
	EzspFrameResponse getResponse();

	/**
	 * Gets a {@link List} of the {@link EzspFrameResponse}s received for the
	 * transaction. This is used for transactions returning multiple responses - for
	 * single response transactions, use {@link #getResponse}.
	 *
	 * @return {@link EzspFrameResponse} to complete the transaction or null if no
	 *         response received
	 */
	...
	/**
	 * Get the {@link EmberStatus} of the transaction. If multiple responses are
	 * returned, this will return the last response indicating the final state of
	 * the transaction.
	 *
