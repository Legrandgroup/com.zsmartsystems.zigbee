...
public class EmberGpAddress {
	...
	public int[] serialize(EzspSerializer serializer) {
		...
		/*
		 * if( 0 == applicationId ) { serializer.serializeUInt8(applicationId);
		 * serializer.serializeUInt8(endpoint); serializer.serializeUInt32(sourceId);
		 * serializer.serializeUInt32(sourceId); } else { //
		 * serializer.serializeEmberEui64(gpdIeeeAddress); System.out.
		 * println("EmberGpAddress serialize ERROR : Unknown application Id Type !!!");
		 * }
		 */
	...
	public void deserialize(EzspDeserializer deserializer) {
		...
		if (0 == applicationId) {
			...
			int l_sourceId = (deserializer.deserializeUInt8() << 24) + (deserializer.deserializeUInt8() << 16)
					+ (deserializer.deserializeUInt8() << 8) + (deserializer.deserializeUInt8() << 0);
			// System.out.println("EmberGpAddress deserialize source1 : " +
			// String.format("%08X", sourceId) + ", source2 : " + String.format("%08X",
			// l_sourceId));
