...
public class EmberInitialSecurityState {
	...
	/**
	 * A bitmask indicating the security state used to indicate what the security
	 * configuration will be when the device forms or joins the network.
	 * <p>
	 * EZSP type is <i>EmberInitialSecurityBitmask</i> - Java type is
	 * {@link EmberInitialSecurityBitmask} Parameter allows multiple options so
	 * implemented as a {@link Set}.
	 */
	private Set<EmberInitialSecurityBitmask> bitmask = new HashSet<EmberInitialSecurityBitmask>();

	/**
	 * The pre-configured Key data that should be used when forming or joining the
	 * network. The security bitmask must be set with the
	 * EMBER_HAVE_PRECONFIGURED_KEY bit to indicate that the key contains valid
	 * data.
	 * <p>
	...
	/**
	 * The Network Key that should be used by the Trust Center when it forms the
	 * network, or the Network Key currently in use by a joined device. The security
	 * bitmask must be set with EMBER_HAVE_NETWORK_KEY to indicate that the key
	 * contains valid data.
	 * <p>
	 * EZSP type is <i>EmberKeyData</i> - Java type is {@link EmberKeyData}
	 */
	...
	/**
	 * The sequence number associated with the network key. This is only valid if
	 * the EMBER_HAVE_NETWORK_KEY has been set in the security bitmask.
	 * <p>
	...
	/**
	 * This is the long address of the trust center on the network that will be
	 * joined. It is usually NOT set prior to joining the network and instead it is
	 * learned during the joining message exchange. This field is only examined if
	 * EMBER_HAVE_TRUST_CENTER_EUI64 is set in the
	 * EmberInitialSecurityState::bitmask. Most devices should clear that bit and
	 * leave this field alone. This field must be set when using commissioning mode.
	 * <p>
	 ...
	 * <p>
	 * EZSP type is <i>EmberInitialSecurityBitmask</i> - Java type is
	 * {@link EmberInitialSecurityBitmask}
	 *
	 ...
	 * data.
	 *
	 * @param preconfiguredKey
	 *            the preconfiguredKey to set as {@link EmberKeyData}
	 */
	 ...
	 *
	 * @param networkKey
	 *            the networkKey to set as {@link EmberKeyData}
	 */
	 ...
	 * the EMBER_HAVE_NETWORK_KEY has been set in the security bitmask.
	 *
	 * @param networkKeySequenceNumber
	 *            the networkKeySequenceNumber to set as {@link int}
	 */
	 ...
	 * leave this field alone. This field must be set when using commissioning mode.
	 *
	 * @param preconfiguredTrustCenterEui64
	 *            the preconfiguredTrustCenterEui64 to set as {@link IeeeAddress}
	 */
