...
public class EzspSendReplyResponse extends EzspFrameResponse {
	...
	/**
	 * An EmberStatus value. EMBER_INVALID_CALL - The EZSP_UNICAST_REPLIES_POLICY is
	 * set to EZSP_HOST_WILL_NOT_SUPPLY_REPLY. This means the NCP will automatically
	 * send an empty reply. The Host must change the policy to
	 ...
	 *            the policyDecision to set as {@link EmberStatus}
	 */
